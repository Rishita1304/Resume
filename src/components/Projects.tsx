...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: "Ieco-friendly transportation by connecting drivers and passengers for shared rides. Say goodbye to traffic congestion and carbon emissions with this innovative carpooling solution.",
        },
        {
