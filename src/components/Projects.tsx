...
const Projects = () => {
    ...
    const projects = [
        ...
        // },
        {
            ...
            description: "An image proceesing platform that consolidates advanced image processing tools, secure payment integration, and robust search capabilities, empowering users to effortlessly enhance, manipulate, and manage visual content.",
        },
        {
